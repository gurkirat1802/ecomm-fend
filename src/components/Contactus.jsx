    ...
    return (
        <>
            <div className="relative h-screen w-full">
                <div className="absolute inset-0 bg-[url('./images/contactus.jpg')] bg-contain bg-center h-3/4">
                    <div className="absolute inset-0 bg-black opacity-70"></div>
                </div>
                <h1 className="absolute font-bold text-6xl top-96 left-64 transform -translate-x-1/2 tracking-wider z-20 text-[#F5F5DC]">
                    CONTACT US
                </h1>
            </div>
            <div className="mx-auto mb-20 flex flex-col md:flex-row md:space-x-24 px-10 md:px-20 space-y-10 md:space-y-0">
                <div className="bg-white p-8 shadow-lg rounded-lg w-full md:w-2/3">
                    ...
                    <span className="text-2xl font-semibold text-seagreen mb-4">+91-88456 89452</span>
                    <hr className="border-gray-300 mb-4 mt-4" />
                    <FontAwesomeIcon icon={faLocationDot} className="text-seagreen mr-2" />
                    <span className="text-2xl font-semibold text-seagreen mb-4">131 Preet Nagar, Ladowali Road, Jalandhar, Punjab</span>
                </div>
